    ...
    return (
        <header className="sticky top-0 transition-all md:grid md:grid-cols-2 items-center px-10 xl:px-20 py-4 z-50 bg-gray-800">
            ...
            <div className="flex items-center justify-end">
                <div className="border border-transparent cursor-pointer hover:bg-gray-800 rounded-full px-3 py-2">
                ...
                <div className="border border-transparent cursor-pointer hover:bg-gray-800 rounded-full p-3">
